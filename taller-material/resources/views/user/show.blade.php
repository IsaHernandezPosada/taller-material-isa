...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <p>{{ $viewData['user']->getRole() }}</p>
            </div>

            <div class="mb-3">
                <label class="fw-bold">Address:</label>
                <p>{{ $viewData['user']->getAddress() }}</p>
            </div>
    ...
    <div class="mt-3">
        ...
        <form action="{{ route('users.destroy', $viewData['user']->getId()) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
